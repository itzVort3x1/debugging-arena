...
export function SubmitButton() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (body.session) mergeSessionMeta(body.session as DebugSessionResponse);
        appendTerminalLine(
      ...
      appendTerminalLine(`✓ Submitted — score ${data.breakdown.score}/100`);
      appendTerminalLine(
  ...
  if (isSubmitted) {
    return (
      <Button size="sm" variant="secondary" disabled title="Session submitted">
