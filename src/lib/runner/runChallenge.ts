...
/**
 * Materialize the challenge into a temp dir, run jest, return the
 * accumulated output + structured counts. Streaming variant lands in
 * PR 5.3 — this version waits for the child to exit before returning.
 *
